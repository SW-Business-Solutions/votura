 ...
 *
 * Beide Pakete kommen in **eine** Liste: Die Begleitanwendung entsteht in
 * einem eigenen Lauf und liegt deshalb woanders — wer eine Datei prüft, will
 * aber nicht wissen, aus welchem Lauf sie stammt.
 *
