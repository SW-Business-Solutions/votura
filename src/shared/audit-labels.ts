...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  'voting.committee_key': 'Prüfschlüssel des Wahlausschusses gemeldet',
  ...
  /* ------------------------------------------------------------ Anträge */
  'motion.created': 'Antrag eingereicht',
  'motion.updated': 'Antrag geändert',
  'motion.status': 'Antrag: Stand geändert',
  ...
  'candidate.quota_group': 'Quotenmerkmal geändert',
